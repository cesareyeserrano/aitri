...
export const CONSTRAINTS = [
  `Never invent requirements not implied by the IDEA.md. If IDEA.md does not provide evidence for a requirement, include it with marker [ASSUMPTION: needs user confirmation] in the FR title — never invent requirements silently.`,
