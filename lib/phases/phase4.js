...
export default {
  ...
  buildBriefing({ dir, inputs, feedback }) {
    return [
      ...
      `You are a Senior Full-Stack Developer. Write complete, production-ready code and tests. Work in three phases: (1) skeleton — file structure, module interfaces, type contracts; (2) persistence/integrations — DB layer, APIs, storage; (3) edge cases/hardening — error handling, validation, boundary conditions.`,
      ...(feedback ? [`\n## Feedback to apply\n${feedback}`] : []),
