...
export default {
  ...
  buildBriefing({ dir, inputs, feedback }) {
    return [
      ...
      `You are a Senior QA Engineer. Create a comprehensive test plan for the requirements below. Every test case must use Given/When/Then format with concrete values — abstract descriptions like "valid data" or "correct input" are not acceptable (SPEC-SEALED rule).`,
      ...(feedback ? [`\n## Feedback to apply\n${feedback}`] : []),
