...
`);
  ...
  Once the artifact is saved, you tell Aitri with "complete".
...
COMMANDS:
  ...
  aitri approve <1-5>                           Approve phase output → unlocks next phase
  aitri reject <1-5> --feedback ""              Reject with feedback → re-run briefing
...
WORKFLOW:
  ...
  3. aitri complete 1              → validates artifact
