...
COMMANDS:
  ...
  aitri complete <1-5|ux|discovery|review> --check     Dry-run validation (no state written)
  ...
  aitri checkpoint [--name <label>]             Save resume snapshot to checkpoints/ (committable)
